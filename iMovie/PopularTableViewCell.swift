...
class PopularTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var popularPosterImageView: UIImageView!
    ...
    func setData(item: FilmList) {
        ...
        popularPosterImageView.layer.cornerRadius = 10
        popularPosterImageView.sd_setImage(with: URL(string: "https://image.tmdb.org/t/p/w188_and_h282_bestv2"+item.poster_path))
